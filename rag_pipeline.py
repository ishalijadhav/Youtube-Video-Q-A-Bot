...
def build_qa_chain(transcript_chunks: List[Dict], groq_api_key: str) -> Dict[str, Any]:
    ...
    # Step 2 — Split long chunks further
    ...
    # Step 3 — Embed locally with HuggingFace (free, no API needed)
    ...
    # Step 4 — LLM: LLaMA 3 via Groq (free tier, very fast)
    llm = ChatGroq(
